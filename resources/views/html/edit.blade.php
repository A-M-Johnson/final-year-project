   ...
   <header>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="project-title" name="title" value="{{$project->title}}" placeholder="Enter project title">
            @error('title')
        ...
        <div class="form-group">
            ...
            <textarea id="project-description" name="description" placeholder="Enter project description">{{$project->description}}</textarea>
            @error('description')
                <div class="invalid-feedback" style="margin: 0.5rem; font-size:80%; color: red;" role="alert">
                    <strong>{{ $message }}</strong>
                </div>
